  ...
  moduleServer( id, function(input, output, session){
    ...
    output$tab_classe <- reactable::renderReactable({
      ...
      da() |>
        ...
        reactable::reactable(
          list(
            classe = reactable::colDef("Classe", minWidth = 200),
            n = reactable::colDef("N"),
            prop = reactable::colDef("%", format = reactable::colFormat(percent = TRUE, digits = 2))
          ),
          compact = TRUE,
          highlight = TRUE
        )
    ...
    output$tab_assunto <- reactable::renderReactable({
      ...
      da() |>
        ...
        reactable::reactable(
          list(
            assunto = reactable::colDef("Assunto", minWidth = 200),
            n = reactable::colDef("N"),
            prop = reactable::colDef("%", format = reactable::colFormat(percent = TRUE, digits = 2))
          ),
          compact = TRUE,
