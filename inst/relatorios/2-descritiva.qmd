...
da_sirenejud_2grau <- readr::read_rds("da_sirenejud_2grau.rds")
### Partes
da_partes_sirenejud <- readr::read_rds("da_partes_sirenejud.rds")

## DataJud
da_datajud <- readr::read_rds("da_datajud.rds")
da_datajud_2grau <- readr::read_rds("da_datajud_2grau.rds")
...
da_rfb_ativo <- readr::read_rds("da_rfb_ativo.rds")
...
```{r}
#| label: tbl-municipios-datajud-2grau
#| tbl-cap: "Tribunais mais comuns nos processos de segundo grau."
da_datajud_2grau |>
...
da_partes_sirenejud <- readr::read_rds("da_partes_sirenejud.rds")
da_partes_sirenejud_ativo <- readr::read_rds("da_partes_sirenejud_ativo.rds")
